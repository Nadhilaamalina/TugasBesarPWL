			...
			<div class="main-sidemenu sidebar-scroll">
				<ul class="side-menu">
					<li class="slide">
                     ...
                     <i class="fas fa-question-circle" style="font-size:20px; margin-right:5px"></i>
						<span class="side-menu__label">About Rs Medikal Inha</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="/data_pegawai"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    ...
                    <i class="far fa-calendar-alt" style="font-size:20px; margin-right:12px"></i>
						<span class="side-menu__label">Data Pendaftaran Pasien</span></a>
					</li>
					<li class="slide">
